...
def run():
    ...
    # 12ms - run the test
    h1.cmd(shell_command_template % (algorithm, '10.0.0.2', '12',
                                     loss_rate[0], 'runtime-rtt12-loss' + str(loss_rate[0]) + '.log'))
    h3.cmd(shell_command_template % (algorithm, '10.0.0.4', '12',
                                     loss_rate[1], 'runtime-rtt12-loss' + str(loss_rate[1]) + '.log'))
    h5.cmd(shell_command_template % (algorithm, '10.0.0.6', '12',
                                     loss_rate[2], 'runtime-rtt12-loss' + str(loss_rate[2]) + '.log'))
    h7.cmd(shell_command_template % (algorithm, '10.0.0.8', '12',
                                     loss_rate[3], 'runtime-rtt12-loss' + str(loss_rate[3]) + '.log'))
    h9.cmd(shell_command_template % (algorithm, '10.0.0.10', '12',
                                     loss_rate[4], 'runtime-rtt12-loss' + str(loss_rate[4]) + '.log'))
    ...
    # 30ms - run the test
    h11.cmd(shell_command_template % (algorithm, '10.0.0.12', '30',
                                      loss_rate[0], 'runtime-rtt30-loss' + str(loss_rate[0]) + '.log'))
    h13.cmd(shell_command_template % (algorithm, '10.0.0.14', '30',
                                      loss_rate[1], 'runtime-rtt30-loss' + str(loss_rate[1]) + '.log'))
    h15.cmd(shell_command_template % (algorithm, '10.0.0.16', '30',
                                      loss_rate[2], 'runtime-rtt30-loss' + str(loss_rate[2]) + '.log'))
    h17.cmd(shell_command_template % (algorithm, '10.0.0.18', '30',
                                      loss_rate[3], 'runtime-rtt30-loss' + str(loss_rate[3]) + '.log'))
    h19.cmd(shell_command_template % (algorithm, '10.0.0.20', '30',
                                      loss_rate[4], 'runtime-rtt30-loss' + str(loss_rate[4]) + '.log'))
    ...
    # 60ms - run the test
    h21.cmd(shell_command_template % (algorithm, '10.0.0.22', '60',
                                      loss_rate[0], 'runtime-rtt60-loss' + str(loss_rate[0]) + '.log'))
    h23.cmd(shell_command_template % (algorithm, '10.0.0.24', '60',
                                      loss_rate[1], 'runtime-rtt60-loss' + str(loss_rate[1]) + '.log'))
    h25.cmd(shell_command_template % (algorithm, '10.0.0.26', '60',
                                      loss_rate[2], 'runtime-rtt60-loss' + str(loss_rate[2]) + '.log'))
    h27.cmd(shell_command_template % (algorithm, '10.0.0.28', '60',
                                      loss_rate[3], 'runtime-rtt60-loss' + str(loss_rate[3]) + '.log'))
    h29.cmd(shell_command_template % (algorithm, '10.0.0.30', '60',
                                      loss_rate[4], 'runtime-rtt60-loss' + str(loss_rate[4]) + '.log'))
    ...
    # 100ms - run the test
    h31.cmd(shell_command_template % (algorithm, '10.0.0.32', '100',
                                      loss_rate[0], 'runtime-rtt100-loss' + str(loss_rate[0]) + '.log'))
    h33.cmd(shell_command_template % (algorithm, '10.0.0.34', '100',
                                      loss_rate[1], 'runtime-rtt100-loss' + str(loss_rate[1]) + '.log'))
    h35.cmd(shell_command_template % (algorithm, '10.0.0.36', '100',
                                      loss_rate[2], 'runtime-rtt100-loss' + str(loss_rate[2]) + '.log'))
    h37.cmd(shell_command_template % (algorithm, '10.0.0.38', '100',
                                      loss_rate[3], 'runtime-rtt100-loss' + str(loss_rate[3]) + '.log'))
    h39.cmd(shell_command_template % (algorithm, '10.0.0.40', '100',
                                      loss_rate[4], 'runtime-rtt100-loss' + str(loss_rate[4]) + '.log'))
    ...
    # 200ms - run the test
    h41.cmd(shell_command_template % (algorithm, '10.0.0.42', '200',
                                      loss_rate[0], 'runtime-rtt200-loss' + str(loss_rate[0]) + '.log'))
    h43.cmd(shell_command_template % (algorithm, '10.0.0.44', '200',
                                      loss_rate[1], 'runtime-rtt200-loss' + str(loss_rate[1]) + '.log'))
    h45.cmd(shell_command_template % (algorithm, '10.0.0.46', '200',
                                      loss_rate[2], 'runtime-rtt200-loss' + str(loss_rate[2]) + '.log'))
    h47.cmd(shell_command_template % (algorithm, '10.0.0.48', '200',
                                      loss_rate[3], 'runtime-rtt200-loss' + str(loss_rate[3]) + '.log'))
    h49.cmd(shell_command_template % (algorithm, '10.0.0.50', '200',
                                      loss_rate[4], 'runtime-rtt200-loss' + str(loss_rate[4]) + '.log'))
    ...
    # 300ms - run the test
    h51.cmd(shell_command_template % (algorithm, '10.0.0.52', '300',
                                      loss_rate[0], 'runtime-rtt300-loss' + str(loss_rate[0]) + '.log'))
    h53.cmd(shell_command_template % (algorithm, '10.0.0.54', '300',
                                      loss_rate[1], 'runtime-rtt300-loss' + str(loss_rate[1]) + '.log'))
    h55.cmd(shell_command_template % (algorithm, '10.0.0.56', '300',
                                      loss_rate[2], 'runtime-rtt300-loss' + str(loss_rate[2]) + '.log'))
    h57.cmd(shell_command_template % (algorithm, '10.0.0.58', '300',
                                      loss_rate[3], 'runtime-rtt300-loss' + str(loss_rate[3]) + '.log'))
    h59.cmd(shell_command_template % (algorithm, '10.0.0.60', '300',
                                      loss_rate[4], 'runtime-rtt300-loss' + str(loss_rate[4]) + '.log'))
